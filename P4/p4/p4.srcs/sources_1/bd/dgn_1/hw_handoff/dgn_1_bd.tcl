...
################################################################
# This is a generated script based on design: dgn_1
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set IRQ_I [ create_bd_port -dir I IRQ_I ]
  ...
  connect_bd_intf_net -intf_net videomemlab_0_axi_periph_M00_AXI [get_bd_intf_pins slv_0/S00_AXI] [get_bd_intf_pins videomemlab_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net IRQ_I_1 [get_bd_ports IRQ_I] [get_bd_pins videomemlab_0/IRQ_I]
  connect_bd_net -net clk_wiz_clk_out1 [get_bd_pins clk_wiz/clk_out1] [get_bd_pins rst_clk_wiz_100M/slowest_sync_clk] [get_bd_pins slv_0/s00_axi_aclk] [get_bd_pins videomemlab_0/m00_axi_aclk] [get_bd_pins videomemlab_0_axi_periph/ACLK] [get_bd_pins videomemlab_0_axi_periph/M00_ACLK] [get_bd_pins videomemlab_0_axi_periph/S00_ACLK]
  connect_bd_net -net clk_wiz_clk_out2 [get_bd_pins clk_wiz/clk_out2] [get_bd_pins slv_0/I_CLK_50MHZ]
  ...
  connect_bd_net -net rst_clk_wiz_100M_peripheral_aresetn [get_bd_pins rst_clk_wiz_100M/peripheral_aresetn] [get_bd_pins slv_0/s00_axi_aresetn] [get_bd_pins videomemlab_0/m00_axi_aresetn] [get_bd_pins videomemlab_0_axi_periph/ARESETN] [get_bd_pins videomemlab_0_axi_periph/M00_ARESETN] [get_bd_pins videomemlab_0_axi_periph/S00_ARESETN]
  ...
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces videomemlab_0/M00_AXI] [get_bd_addr_segs slv_0/S00_AXI/S00_AXI_reg] -force
