...
#
# Generated by export_simulation on Tue Mar 30 21:50:07 -0400 2021
#
################################################################################
...
'-reset_run' switch to the './dgn_1.sh' script.
...
./dgn_1.sh -noclean_files

For more information on the script, please type './dgn_1.sh -help'.
